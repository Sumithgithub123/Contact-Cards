      ...
      <div className="mt-4 grid-cols-1 xl:gap-0 gap-x-2 xl:gap-x-24  md:grid-cols-3 grid ">
        ...
        <div className="md:mt-0 mt-2 space-y-2">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-stone-200 px-2 py-1 w-[400px] md:w-44 xl:w-56"
              type="text"
              id="name"
              value={formname}
              defaultValue={name}
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              required
              className="bg-stone-200 h-[58px] px-2 py-1 w-[400px] md:w-44 xl:w-56"
              type="text"
              id="address"
              value={formaddress}
              defaultValue={add}
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="bg-stone-200 h-[70px] px-2 py-1 w-[400px] md:w-44 xl:w-56"
              type="text"
              id="catchPhrase"
          ...
          <div>
            <button
              ...
              className="text-white w-[400px]  md:w-44 xl:w-56 p-2 mt-3 rounded-full bg-slate-500"
            >
              Update
            </button>
          </div>
